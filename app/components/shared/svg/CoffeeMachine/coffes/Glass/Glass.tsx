...
export function GlassSvg () {
  return (
    ...
    >
      <g id='vaso_coffee'>
        <path
          className={styles.st0} d='M283.44,397.98H112.44c-6.39,0-11.82-4.79-12.53-11.18L61.77,56.47h274.4l-40.2,330.41
		C295.22,393.23,289.84,397.98,283.44,397.98z'
        />
        <path
          className={styles.st1} d='M349.29,55.92H48.65c-6.98,0-12.61-5.63-12.61-12.61V14.63c0-6.98,5.63-12.61,12.61-12.61h300.64
		c6.98,0,12.61,5.63,12.61,12.61v28.68C361.91,50.29,356.27,55.92,349.29,55.92z'
        />

        <ellipse transform='matrix(0.4941 -0.8694 0.8694 0.4941 -76.5536 275.9543)' className={styles.st1} cx='198.84' cy='203.76' rx='62.69' ry='44.78' />
        <g>
          <path
            className={styles.st2} d='M160.45,253.84c20.14-8.91,27.58-31.91,33.3-51.38c0,0.08,10.55,2.1,10.26,2.35l-10.3-2.06
