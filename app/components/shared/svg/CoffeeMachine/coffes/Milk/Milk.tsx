...
export function MilkSvg () {
  return (
    ...
    >
      <g id='milk'>
        <path
          className={styles.st0} d='M293.13,369.38H104.86c-4.5,0-8.3-3.36-8.78-7.86L56.49,19.09c-0.6-5.26,3.52-9.87,8.78-9.87h269.45
		c5.31,0,9.44,4.66,8.78,9.92l-41.65,342.43C301.37,366.02,297.63,369.38,293.13,369.38z'
        />
        <path
          className={styles.st1} d='M274.04,338.26H124.38c-3.58,0-6.62-2.66-7-6.13L85.93,65.34c-0.49-4.12,2.77-7.7,7-7.7h214.19
