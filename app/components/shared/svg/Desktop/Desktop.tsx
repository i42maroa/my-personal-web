...
export function DesktopSvg () {
  return (
    <svg
      ...
      viewBox='0 0 800 800' className={styles.container} xmlSpace='preserve'
    >
      <g id='desktop'>
        <path
          className={styles.st0} d='M751.6,269.8H599.7v-23.5h151.9V269.8z M751.6,285.1H599.7v23.5h151.9V285.1z M751.5,178.7H599.9v51.7h151.6
      ...
      <g id='lines'>
        ...
        <rect x='80.3' y='387.7' className={styles.l6} width='171' height='6' />
        <rect x='80.3' y='357.5' className={styles.l5} width='316' height='6' />
        <rect x='80.3' y='332.3' className={styles.l4} width='267' height='6' />
        <rect x='80.3' y='309.2' className={styles.l3} width='318' height='6' />
        <rect x='80.3' y='283.6' className={styles.l2} width='280' height='6' />
        <rect x='80.3' y='258' className={styles.l1} width='328' height='6' />
      </g>
    </svg>
  )
}
