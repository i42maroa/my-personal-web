...
export function LinkedinSvg ({ isPresentation }:{isPresentation:boolean}) {
  return (
    <svg
      ...
      viewBox='0 0 400 400' className={`${styles.container} ${isPresentation ? styles.presentation : styles.footer}`} xmlSpace='preserve'
    >
      <g>
        <path d='M363.17,16.76H40.78c-15.02,0-27.24,12.22-27.24,27.24v322.39c0,15.02,12.22,27.24,27.24,27.24h322.39
        ...
        />
        <path d='M363.17,17.76H40.78c-14.47,0-26.24,11.77-26.24,26.24v322.39c0,14.47,11.77,26.24,26.24,26.24h322.39
