...
export function LinkedinSvg () {
  return (
    ...
    >
      <g>
        <path
          className={styles.st0} d='M363.17,16.76H40.78c-15.02,0-27.24,12.22-27.24,27.24v322.39c0,15.02,12.22,27.24,27.24,27.24h322.39
        ...
        />
        <path
          className={styles.st0} d='M363.17,17.76H40.78c-14.47,0-26.24,11.77-26.24,26.24v322.39c0,14.47,11.77,26.24,26.24,26.24h322.39
