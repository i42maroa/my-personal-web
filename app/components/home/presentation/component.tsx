    ...
    <div className={styles.sectionWrapper}>
      <section id={LINKS[PAGES.HOME].sections[0]} className={styles.sectionContainer}>
        ...
        <header className={styles.header}>
          <h1 className={styles.title}><span className={styles.title}>Hola, mi nombre es <b>Antonio</b> </span></h1>
          <p className={styles.text}>Soy un <b>desarrollador web creativo</b> y sobre todo un apasionado del <b>café</b>.</p>
